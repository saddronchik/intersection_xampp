    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <form action={{route('users.updatePass',$user->id)}} method="post" class="form" id="formUpdate" >
                    @csrf
                    ...
                    <tbody>
                            ...
                            <tr>
                                <td>Пароль</td>
                                <td><input id="password" name="password" class="form-control" value=""></td>
                            </tr>
{{--                            <tr>--}}
...
{{--                            </tr>--}}
                    ...
                    <a href="{{route('users.list')}}" class="btn btn-primary">Назад</a>
