    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-10">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <a class="btn btn-primary btn-sm mb-2 " href="{{route('citisen.export')}}"
                                   role="button">Экпорт граждан в Excel</a>
                                ...
                                <form action="{{route('citisen.import')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input class="btn btn-primary btn-sm mb-2" type="checkbox" value="true"
                                           name="haveHead" id="haveHead">
                ...
                <a class="btn btn-primary mb-2 float-right" href="{{route('events.create')}}" role="button">Добавить
                    событие</a>
                    ...
                    @foreach ($citisens as $citisen)
                        ...
                        <tr>
                            ...
                            <th scope="row" id="idcitisen" name="idcitisen"
                                value="{{ $citisen->id }}">{{ $citisen->id }}</th>
                            @role('admin')
                            <td class="col-md-2"><a href="citisen/{{$citisen->id}}">{{ $citisen->full_name }}</td>
                            @else
                                <td class="col-md-2">
                                    <span class="mail" style="color: blue" data-toId="{{ $citisen->id_user}}"
                                          data-Id="{{ $citisen->id }}"
                                          data-ctisenname="{{ $citisen->full_name }}">{{ $citisen->full_name }} </span>
                                </td>
